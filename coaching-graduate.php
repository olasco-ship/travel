<head>
	<title>Graduate Re-Exam || Migrate || Immigration Service Responsive HTML 5 Template</title>
...
<!--Start Coaching Detail Area-->
<section class="coaching-detail-area">
    <div class="container">
        <div class="row">
                ...
                <div class="sidebar-style1 style1instyle2">
                    ...
                    <div class="single-sidebar-style1">
                        <ul class="page-links">
                            ...
                            <li><a href="coaching-pte.html">PTE Coaching<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                            <li><a href="coaching-toefl.html">TOEFL<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                            <li class="active"><a href="coaching-graduate.html">Graduate Re Exam<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="left">
                                            ...
                                            <div class="text">
                                                <h4>Download<br> our Brochures</h4>
                                            </div>
                                        </div>
                                        <div class="right">
                                            <span class="flaticon-download-interface-symbol-of-down-arrow-on-a-tray"></span>    
                                        </div>
                                    </a>
                                </li>
                                <li>
            ...
            <div class="col-xl-8 col-lg-8 col-md-12 order-box-1">
                <div class="coaching-detail-content">
                    <div class="img-box">
                        <img src="assets/images/resources/coaching-detail-image-1.jpg" alt="Awesome Image">
                    </div>
                    <div class="text-box">
                        <div class="inner-content">
                            <h2>Graduate Re-Exam Coaching Overview</h2>
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <ul>
                                        <li>
                                            <div class="icon">
                                                <span class="flaticon-check-mark-1"></span>
                                            </div>
                                            <div class="text">
                                                <p>Need expertise help, wherever you<br> in the world.</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon">
                                            ...
                                            <div class="text">
                                                <p>Check Information provide in your passport.</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon">
                                            ...
                                            <div class="text">
                                                <p>Go to the official website IELTS & create<br> profile.</p>
                                            </div>
                                        </li>
                                    </ul>    
                                </div>
                                <div class="col-xl-6">
                                    <ul>
                                        <li>
                                            ...
                                            <div class="text">
                                                <p>Speaking or writing score review form your exam.</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon">
                                            ...
                                            <div class="text">
                                                <p>Additional reports institution of coaching center</p>
                                            </div>
                                        </li>
                                    </ul>    
                                </div>
                        ...
                        <div class="coaching-prepare-content">
                            <div class="title">
                                <h2>How to Prepare for IELTS Exam</h2>
                            </div> 
                            <div class="img-box">
                                <img src="assets/images/resources/coaching-detail-image-2.jpg" alt="Awesome Image">
                            </div>
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="left">
                                ...
                                <div class="col-xl-6">
                                    <div class="right">
                                        ...
                                        <div class="img-holder">
                                            <img src="assets/images/resources/coaching-detail-image-3.jpg" alt="Awesome Image">
                                        </div>    
                                    </div>    
                                </div>
                            </div>   
