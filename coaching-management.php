<head>
	<title>Management Test || Migrate || Immigration Service Responsive HTML 5 Template</title>
                ...
                <div class="sidebar-style1 style1instyle2">
                    ...
                    <div class="single-sidebar-style1">
                        <ul class="page-links">
                            ...
                            <li class="active"><a href="coaching-management.html">Management Test<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                        </ul>    
                    </div>
                ...
                <div class="coaching-detail-content">
                    ...
                    <div class="text-box">
                        <div class="inner-content">
                            <h2>Management Test Overview</h2>
