<head>
	<meta charset="UTF-8">
	<title>Diplomatic Visa || Migrate || Immigration Service Responsive HTML 5 Template</title>
        ...
        <div class="row">
            <div class="col-xl-8 col-lg-8 col-md-12">
                <div class="visa-detail-content">
                    <div class="img-box">
                        <img src="assets/images/visa/visa-detail-1-cat-6.jpg" alt="Awesome Image">
                    </div>
                    <div class="text-box">
                        <h2>Diplomatic Visa</h2>
