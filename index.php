                ...
                <div class="theme-carousel event-carousel owl-carousel owl-theme owl-dot-style1" data-options='{"loop":true, "margin":40, "autoheight":true, "nav":false, "dots":true, "autoplay":true, "stagePadding":15, "autoplayTimeout":10000, "smartSpeed":700, "responsive":{ "0":{"items": "1"}, "500":{"items": "1"}, "767":{"items": "2"}, "1199":{"items": "3"}, "1600":{"items": "3"} }}'>
                    ...
                    <div class="single-visa-box">
                        <div class="img-holder">
                            <div class="inner">
                                <img src="assets/images/visa/visa-1.jpg" alt="Awesome Image">
                    ...
                    <div class="single-visa-box">
                        <div class="img-holder">
                            <div class="inner">
                                <img src="assets/images/visa/visa-2.jpg" alt="Awesome Image">
                                <div class="overlay-style-one bg1"></div>
                            </div>
                    ...
                    <div class="single-visa-box">
                        <div class="img-holder">
                            <div class="inner">
                                <img src="assets/images/visa/visa-3.jpg" alt="Awesome Image">
                                <div class="overlay-style-one bg1"></div>
                            </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="visa-assessment-box">
                    <div class="img-holder">
                        <img src="assets/images/resources/visa-assessment.jpg" alt="Awesome Image">
                    </div>
                    <div class="text-holder">
                        <div class="sec-title">
                            <h3>Get Free</h3>
                        ...
                        <div class="inner-content">
                            ...
                            <div class="btns-box">
                                <a class="btn-one style2" href="#"><span class="txt">Discover More<i class="fa fa-angle-double-right" aria-hidden="true"></i></span></a>
                            </div>
                        </div>
                    </div>    
                </div>
...
<section class="select-country-area" style="background-image: url(assets/images/parallax-background/select-country-bg.jpg)">
    <div class="container">
        <div class="sec-title text-center">
        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="single-select-country">
                    <div class="img-holder">
                        <img src="assets/images/resources/country-1.jpg" alt="Awesome Image">
                    </div>
                    <div class="text-holder">
                        <h3>United States</h3>
            ...
            <div class="col-xl-6">
                <div class="single-select-country">
                    <div class="img-holder">
                        <img src="assets/images/resources/country-2.jpg" alt="Awesome Image">
                    </div>
                    <div class="text-holder">
                        <h3>Australia</h3>
                        <p>Studying In The Australia of Australia quis nostrud exercitation</p>
                        <a href="#">Read More<span class="flaticon-right"></span></a>
                    </div>    
                </div>    
            </div>
            ...
            <div class="col-xl-6">
                <div class="single-select-country">
                    <div class="img-holder">
                        <img src="assets/images/resources/country-3.jpg" alt="Awesome Image">
                    </div>
                    <div class="text-holder">
                        <h3>Canada</h3>
            ...
            <div class="col-xl-6">
                <div class="single-select-country">
                    <div class="img-holder">
                        <img src="assets/images/resources/country-4.jpg" alt="Awesome Image">
                    </div>
                    <div class="text-holder">
                        <h3>United Kingdom</h3>
                        <p>Studying In The United Kingdom of UK quis nostrud exercitation</p>
                        <a href="#">Read More<span class="flaticon-right"></span></a>
                    </div>    
                </div>    
            </div>
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="choose-left-box">
                    ...
                    <div class="video-holder-box" style="background-image: url(assets/images/resources/video-gallery-bg.jpg)">
                        <div class="icon">
            ...
            <div class="col-xl-6">
                <div class="choose-content-box">
                    <div class="sec-title">
                        <h3>Why Choose Us</h3>
                        <h2>Experienced Lawyers Provide<br> <span>Immigration Services.</span></h2>
                    </div>
                    <div class="inner-content">
                        <h3>We've been counselling students for educational Opportun in Foreign countries.</h3>
                        <p>Once you have decided that you are comfortable with our assessment, we ill provide you with a complete breakdown of all service fees from beginning to end with no hidden fees!</p>
                        <div class="progress-levels">
                            <!--Skill Box-->
                            <div class="progress-box wow">
                                <div class="inner count-box">
                                    <div class="text">Student Consultency</div>
                                    <div class="bar">
                            ...
                            <div class="progress-box wow">
                                <div class="inner count-box">
                                    <div class="text">Immigration Consultency</div>
                                    <div class="bar">
                                        <div class="bar-innner">
                                            <div class="skill-percent">
                            ...
                            <div class="progress-box wow last-child">
                                <div class="inner count-box">
                                    <div class="text">Tourist Consultency</div>
                                    <div class="bar">
                                        <div class="bar-innner">
                                            <div class="skill-percent">
...
<section class="team-area">
    <div class="container">   
        <div class="sec-title text-center wow slideInDown animated" data-wow-delay="0.1s" data-wow-duration="1200ms">
            <h3>OUR AGENT</h3>
            <h2>Meet Now Our Dedicated<br> <span>Expert Team.</span></h2>
        </div>
        <div class="row">
...
<section class="slogan-area">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                <div class="slogan-content wow slideInUp" data-wow-delay="100ms" style="background-image: url(assets/images/pattern/slogan-content-bg.jpg)">
                    <div class="left">
                        <div class="icon">
                            <span class="flaticon-technology thm-clr"></span>
                        </div>
                        <div class="title">
                            <p>We Run a Wide Range of</p>
                            <h3>Migration Administrations That Promise Your Prosperity</h3>
                        </div>
                    </div>
                    <div class="right">
                        <div class="btns-box">
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="single-blog-style1 wow fadeInLeft" data-wow-delay="100ms" data-wow-duration="1500ms">
                    ...
                    <div class="text-holder">
                        ...
                        <h3><a href="blog-single.html">What Are The Best Countries to Immigrate With The Family?</a></h3>
                    </div>   
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="single-blog-style1 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                    ...
                    <div class="text-holder">
                        <ul class="meta-info">
                            <li><span class="flaticon-user thm-clr"></span><a href="#">By admin</a></li>
                            <li><span class="flaticon-open-archive thm-clr"></span><a href="#">Business Visa</a></li>
                            <li><span class="flaticon-conversation thm-clr"></span><a href="#">02</a></li>
                        </ul>
                        <h3><a href="blog-single.html">Required Documents for Family Immigration Visas</a></h3>
                    </div>   
                </div>
            </div>
            <!--End Single blog Style1-->
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="single-blog-style1 wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1500ms">
                    ...
                    <div class="text-holder">
                        ...
                        <h3><a href="blog-single.html">Seven Reasons People Decide to Move to Another Country</a></h3>
                    </div>   
                </div>
            </div>
            <!--End Single blog Style1-->
