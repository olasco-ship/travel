<head>
	<title>Team || Migrate || Immigration Service Responsive HTML 5 Template</title>
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 wow animated fadeInUp" data-wow-delay="0.7s">
                <div class="single-team-member marbtm20">
                    <div class="img-holder">
                        <div class="inner">
                            <img src="assets/images/team/team-v1-8.jpg" alt="Awesome Image">
                            <div class="overlay-style-one bg2"></div>
                            <div class="team-social-links">
                                <ul>
                                    <li>
