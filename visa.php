<head>
	<title>Visa || Migrate || Immigration Service Responsive HTML 5 Template</title>
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-12">
                <div class="single-visa-box marbtm60">
                    <div class="img-holder">
                        <div class="inner">
                            <img src="assets/images/visa/visa-4.jpg" alt="Awesome Image">
                            <div class="overlay-style-one bg1"></div>
                        </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-12">
                <div class="single-visa-box marbtm60">
                    <div class="img-holder">
                        <div class="inner">
                            <img src="assets/images/visa/visa-5.jpg" alt="Awesome Image">
                            <div class="overlay-style-one bg1"></div>
                        </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-12">
                <div class="single-visa-box marbtm60">
                    <div class="img-holder">
                        <div class="inner">
                            <img src="assets/images/visa/visa-6.jpg" alt="Awesome Image">
                            <div class="overlay-style-one bg1"></div>
                        </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-12">
                <div class="single-visa-box marbtm60">
                    <div class="img-holder">
                        <div class="inner">
                            <img src="assets/images/visa/visa-7.jpg" alt="Awesome Image">
                            <div class="overlay-style-one bg1"></div>
                        </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-12">
                <div class="single-visa-box marbtm60">
                    <div class="img-holder">
                        <div class="inner">
                            <img src="assets/images/visa/visa-8.jpg" alt="Awesome Image">
                            <div class="overlay-style-one bg1"></div>
                        </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-12">
                <div class="single-visa-box marbtm60">
                    <div class="img-holder">
                        <div class="inner">
                            <img src="assets/images/visa/visa-9.jpg" alt="Awesome Image">
                            <div class="overlay-style-one bg1"></div>
                        </div>
