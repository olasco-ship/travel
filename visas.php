<head>
    ...
    <?php $page = 'visas';include('./partials/header.php') ?>
</head>
...
<?php include('./partials/nav.php') ?>
    <section class="visa_top">
        <h3 class="visa_title">A <span class="blue">clear path </span> to immigration</h3>
        <p>Canadian and U.S. professional immigration services expertly designed to save you time and money <br>for your recommended visa. Explore our available visas for our destination country.</p>
    </section>
