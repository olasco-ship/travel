...
<section class="mt-4">
        <div class="first">
            ...
            <a href="#"><span class="text">United States</span></a> 
            <span class="icon"><i class="bi bi-chevron-right"></i></span>
...
<div class="header-top1">
    ...
    <div>
        <h6>Would you like to visit the U.S. for business or recreational purposes?</h6><br>
    </div>
</section>
...
<section class="container">
    <div>
        ...
        <div>
            <ol type="1">
                <li>
                    <u>Use our free eligibility checker</u> to quickly see if you are from a visa-exempt country, or if you need a Visitor Visa.
                </li>

                <li>
                    Or, start your application by creating an account. It is free and will check if you are eligible. With an account, you can schedule a call with one of our immigration experts.
                </li>
            </ol>
        </div>
