            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
						...
						<li class="accordion">
                            <a href="#"><i class="glyphicon glyphicon-th-large"></i><span>Products Manager</span></a>
						...
						<li class="accordion">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <li> <a class="ajax-link" href="services.php">Home Page</a></li>
                                <li> <a class="ajax-link" href="aboutus.php">About Us Page</a></li>
                                <li> <a class="ajax-link" href="faq.php">Visa Page</a></li>
                                <!-- <li> <a class="ajax-link" href="video.php">Video</a></li> -->
								

                                <li> <a class="ajax-link" href="review.php">Reviews</a></li>
...
<li class="accordion">
                            <a href="#"><i class="glyphicon glyphicon-th-large"></i><span>Blog</span></a>
                            <ul class="nav nav-pills nav-stacked">
                                <li> <a class="ajax-link" href="pageform.php">Page Form</a></li>
                                <li> <a class="ajax-link" href="pages.php">Pages</a></li>
