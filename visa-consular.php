<head>
	<title>Consular Closings || Migrate || Immigration Service Responsive HTML 5 Template</title>
        ...
        <div class="row">
            <div class="col-xl-8 col-lg-8 col-md-12">
                <div class="visa-detail-content">
                    <div class="img-box">
                        <img src="assets/images/visa/visa-detail-1-cat-5.jpg" alt="Awesome Image">
                    </div>
                    <div class="text-box">
                        <h2>Consular Closings</h2>
                ...
                <div class="sidebar-style1">
                    ...
                    <div class="single-sidebar-style1">
                        <ul class="page-links">     
                            ...
                            <li class="active"><a href="visa-consular.html"><i class="fa fa-angle-left" aria-hidden="true"></i>Consular Closings</a></li>
